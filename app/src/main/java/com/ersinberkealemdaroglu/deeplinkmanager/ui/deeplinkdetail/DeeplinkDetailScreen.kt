...
import com.ersinberkealemdaroglu.deeplinkmanager.ui.component.DeleteButton
...
fun DeeplinkDetailScreen(
    ...
    onDeleteDeeplinkButtonClicked: () -> Unit = {},
) {
    val context = LocalContext.current
    var title by remember { mutableStateOf(deeplinkModel.title) }
    var url by remember { mutableStateOf(deeplinkModel.url) }

    Column(modifier = modifier) {
        CustomToolbar(
            modifier = Modifier.fillMaxWidth(),
            title = "Update Deeplink",
        ...
        DeleteButton(
            modifier = Modifier
                .fillMaxWidth()
                .padding(start = 24.dp, end = 24.dp, top = 24.dp), text = "Delete", onClick = {
                onDeleteDeeplinkButtonClicked.invoke()
            })

        PrimaryButton(
            modifier = Modifier
                .fillMaxWidth()
                .padding(24.dp), text = "Update", onClick = {
    ...
    DeeplinkManagerTheme {
        DeeplinkDetailScreen(
            Modifier
                ...
                .fillMaxSize(), onBackButtonClicked = {}, deeplinkModel = DeeplinkModel(
                id = 1, title = "Example Deeplink", url = "example://deeplink"
